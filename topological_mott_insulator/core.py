...
__all__ = ['checkerboard_lattice_un', 'numbern', 'chern']
...
class checkerboard_lattice_un:
    """Unrestricted Hartree-Fock class to solve self-consistently the system Hamiltonian``.
        ...
        cell_filling: float
            Number of particles per 2-site unit cell. The total number of particles is then computed as cell_filling*L, being L the number of cells.
